...
void loop() {
  ...
  int16_t yaw_int = (int16_t)(gyroYaw * 100);
  memcpy(buffer, &roll_int, 2);
  memcpy(buffer + 2, &pitch_int, 2);
  memcpy(buffer + 4, &yaw_int, 2);

  Serial.write(buffer,6);*/
  //Serial.print(pitch_int); Serial.print("  "); Serial.println(roll_int); 
